    ...
    public class SharedController : Controller
    {
        public JsonResult UploadImage()
        {
            ...
            try
            {
                ...
                var path = Path.Combine(Server.MapPath("~/content/images/CaegoryImages"), fileName);

                file.SaveAs(path);

                result.Data = new { Success = true, ImageURL = string.Format("/content/images/CaegoryImages/{0}", fileName) };
